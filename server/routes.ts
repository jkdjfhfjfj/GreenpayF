  ...
  app.get("/api/admin/database/tables-exist", async (req, res) => {
    try {
      ...
      res.json({
        success: true,
        tablesExist,
        message: tablesExist ? "Database tables exist" : "Database tables do not exist"
      });
    } catch (error) {
    ...
    try {
      ...
      const createTablesSQL = `
        ...
        CREATE TABLE IF NOT EXISTS users (
          ...
          kes_balance DECIMAL(10, 2) DEFAULT 0.00,
        ...
        CREATE TABLE IF NOT EXISTS payment_requests (
          ...
          recipient_id VARCHAR(36) REFERENCES recipients(id),
          to_email TEXT,
          to_phone TEXT,
          amount DECIMAL(10, 2) NOT NULL,
          currency TEXT NOT NULL DEFAULT 'KES',
        ...
        CREATE TABLE IF NOT EXISTS support_tickets (
          ...
          assigned_admin_id VARCHAR(36) REFERENCES users(id) ON DELETE SET NULL,
          admin_notes TEXT,
        ...
        CREATE TABLE IF NOT EXISTS system_settings (
          ...
          value JSON NOT NULL,
          description TEXT,
          updated_by VARCHAR(36) REFERENCES admins(id),
          updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
        );
        ...
        CREATE TABLE IF NOT EXISTS scheduled_payments (
          id VARCHAR(36) PRIMARY KEY DEFAULT gen_random_uuid(),
          user_id VARCHAR(36) NOT NULL REFERENCES users(id) ON DELETE CASCADE,
          recipient_id VARCHAR(36) NOT NULL REFERENCES recipients(id),
          amount DECIMAL(10, 2) NOT NULL,
          currency TEXT NOT NULL DEFAULT 'KES',
        ...
        CREATE TABLE IF NOT EXISTS payhero_details (
          id VARCHAR(36) PRIMARY KEY DEFAULT gen_random_uuid(),
          user_id VARCHAR(36) NOT NULL UNIQUE REFERENCES users(id) ON DELETE CASCADE,
          payhero_account_id TEXT NOT NULL UNIQUE,
          phone_number TEXT NOT NULL,
      ...
      await db.execute(createTablesSQL as any);
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : "Failed to initialize database tables"
      });
    }
  });
